...
const Footer = () => {
    return (
        <>
            <footer className="footer px-16 py-12 font-semibold bg-base-200 text-base-content"
            ...
            <footer className="footer px-10 py-8 border-t bg-base-200 text-base-content font-semibold border-base-300">
