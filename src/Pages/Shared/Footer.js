...
const Footer = () => {
    return (
        <>
            <footer className="footer container mx-auto px-16 py-12 font-semibold bg-base-200 text-base-content"
            ...
            <footer className="footer mx-auto px-10 py-8 border-t bg-base-200 text-base-content font-semibold border-base-300">
                <div className='mx-auto container flex items-center justify-between'>
                    <div className="items-center grid-flow-col">
                        <p>Copyright © 2023. All Right Reserved to Doctor's Portal. </p>
                    </div>
